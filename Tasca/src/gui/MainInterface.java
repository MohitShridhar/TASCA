...
public class MainInterface {
    ...
    public static Font mesloReg16 = null;
    public static Font mesloBold16 = null;
...
//	menloReg16 = new Font("Menlo", Font.PLAIN, 16);
    ...
    public static void createMinimizeButton(final JFrame frame) {
	...
	btnMinimize.setBorder(BorderFactory.createEmptyBorder(0,0,0,0));
	...
	scrollPane.setLocation(50, 425 -2);
	scrollPane.setSize(745, 19 + 4);
    ...
    public static void initiateIndicators(final JFrame frame) {
	try {
	...
	Runtime.getRuntime().addShutdownHook(new Thread(new Runnable() {
	    ...
	    public void run() {
		controller.executeCommands(interpreter.getDefaultCommandSyn(CommandType.QUIT));
	    }
	}));
    }
    ...
    public static void createCloseButton(final JFrame frame) {
